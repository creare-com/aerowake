...
if __name__ == '__main__':
	...
	while True:
		pass
		# # Occasionally change a GCS parameter
		# gcs.parameters['PIVOT_TURN_ANGLE'] = gcs.parameters['PIVOT_TURN_ANGLE'] + 1
		# print 'Changed gcs.parameters[''PIVOT_TURN_ANGLE''] to %s' %(gcs.parameters['PIVOT_TURN_ANGLE'])
		# time.sleep(5)
